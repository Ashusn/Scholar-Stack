...
import { FaSmile, FaChartBar } from "react-icons/fa";
import { HiCursorClick } from "react-icons/hi";
import benefitOneImg from "../assests/image-2.webp";

const benefitOne = {
  title: "Explore the Benefits of ScholarStack",
  desc: "Unlock the Potential of Effortless Research Paper Management",
  image: benefitOneImg,
  bullets: [
    {
      title: "Seamless Organization",
      desc: "you can effortlessly organize and categorize your research papers, ensuring you can quickly locate and access the information you need.",
      icon: <FaSmile />,
    },
    {
      title: "Enhanced Collaboration",
      desc: "you can easily share your research papers with colleagues and collaborators.",
      icon: <FaChartBar />,
    },
    {
      title: "Time Efficiency",
      desc: "Focus more on your research projects and less on administrative tasks with our intuitive, time-saving features.",
      icon: <HiCursorClick />,
    },
  ],
};
